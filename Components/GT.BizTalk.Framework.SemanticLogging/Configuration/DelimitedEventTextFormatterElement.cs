...
{
    /// <summary>
    /// Represents a configuration element that can create an instance of <see cref="DelimitedEventTextFormatter"/>.
    /// </summary>
    public class DelimitedEventTextFormatterElement : IFormatterElement
    {
        private readonly XName formatterName = XName.Get("delimitedEventTextFormatter", Constants.Namespace);
        ...
        public IEventTextFormatter CreateFormatter(XElement element)
        {
            ...
            EventLevel verbosityThreshold = (EventLevel)Enum.Parse(typeof(EventLevel), (string)formatter.Attribute("verbosityThreshold") ?? DelimitedEventTextFormatter.DefaultVerbosityThreshold.ToString());

            return new DelimitedEventTextFormatter(
                (string)formatter.Attribute("delimiter"),
                verbosityThreshold,
