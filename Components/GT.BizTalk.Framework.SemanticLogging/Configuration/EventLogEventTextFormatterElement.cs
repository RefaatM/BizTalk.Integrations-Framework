...
{
    /// <summary>
    /// Represents a configuration element that can create an instance of <see cref="EventLogEventTextFormatter"/>.
    /// </summary>
    internal class EventLogEventTextFormatterElement : IFormatterElement
    {
        private readonly XName formatterName = XName.Get("eventLogEventTextFormatter", Constants.Namespace);
        ...
        public IEventTextFormatter CreateFormatter(XElement element)
        {
            ...
            return new EventLogEventTextFormatter(
                verbosityThreshold,
